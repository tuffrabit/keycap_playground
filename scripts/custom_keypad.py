...
ROW_PROFILES = {
    #1: {"key_height": 9.5, "dish_tilt": 12, "dish_z": -0.4,
    #    "description": "tallest, back high"},
    1: {"key_height": 15.5, "dish_tilt": 16, "dish_z": -0.4,
        "description": "tallest, back high"},
    2: {"key_height": 8.8, "dish_tilt": 6,  "dish_z": -0.2,
        "description": "medium, slight back tilt"},
    3: {"key_height": 8.2, "dish_tilt": 0,  "dish_z": 0.0,
        "description": "short, flat"},
    4: {"key_height": 8.8, "dish_tilt": 6,  "dish_z": -0.2,
...
class custom_keypad_base(Keycap):
    """
    Base keycap tuned for a sculpted, Riskeycap-style profile printed on its side.

    * 1U square caps
    * Rotated to print on the side for smooth tops and strong stems
    ...
    * Uses globals mode so per-row height and dish_tilt can be applied
    ...
    def __init__(self, **kwargs):
        ...
        self.key_top_y = 0
        # Rotate the cap so it prints on its side.  Use [0, 110.1, 90] instead
        # if you want the opposite flank facing the build plate.
